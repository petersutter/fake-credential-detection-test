// source (slightly modified): https://github.com/kubernetes/autoscaler/blob/master/cluster-autoscaler/cloudprovider/brightbox/k8ssdk/testing.go
...
func GetAuthEnvTokenHandler(t *testing.T) *httptest.Server {
	...
	ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		expected = "Basic YXBwLWRrbWNoOnVvZ29lbHpndDBud2F3Yw=="
